...
from 核心.StudentManagerSystem.student import \
    Student  # 之前文件嵌套太深了(嵌套在12 模块封装和异常处理中识别不到)Pycharm识别不了,拿到核心1当中才识别到的
...
class StudentManager:
    ...
    def save_student(self):
        ...
        with open('students.json', mode='w', encoding='utf-8') as f:
            final_stu_list = [
                {"name": i.name, "chinese": i.chinese, "math": i.math,
                 "english": i.english, "total": i.total, } for i in
                self.student_list]
...
**************************************************"""
    ...
    def load_student(self):
        ...
        self.student_list = [
            Student(i['name'], i['chinese'], i['math'], i['english'], ) for i
            in new_list]
